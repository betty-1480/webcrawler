 ...
 */
@JsonDeserialize(builder = CrawlerConfiguration.Builder.class) //"tell" Jackson that CrawlerConfiguration uses the builder pattern by annotating the CrawlerConfiguration class with the @JsonDeserialize annotation
public final class CrawlerConfiguration {
  ...
  public static final class Builder {
     ...
     */
    @JsonProperty("startPages") //define the mapping between JSON property names and builder methods by annotating each of the builder's setter methods with @JsonProperty
